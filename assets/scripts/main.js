...
jQuery(function () {
    ...
    const formats = ["jpg", "jpeg", "gif", "png", "html", "css", "csv", "zip", "7z", "doc", "docx", "xls", "xlsx", "txt", "js", "torrent", "sql", "avi", "mp4", "gzip"];
    ...
    preLink.each(function () {
        ...
        for (let i = 0; i < formats.length; i++) {
            if (fileExt.toLowerCase() === formats[i].toLowerCase()) {
                found = 1;
                oldText = $(this).text();
                $(this).html('<img class="icons" src="https://reckfularchive.github.io/files/assets/images/icons/' + formats[i] + '.png"></a>' + oldText);
                return;
            }
        }
        ...
        if ($(this).text().indexOf("Parent Directory") >= 0) {
            found = 1;
            oldText = $(this).text();
            $(this).html('<img class="icons" src="https://reckfularchive.github.io/files/assets/images/icons/home.png">' + oldText);
            return;
        }
        ...
        if ($(this).attr('href').substring($(this).attr('href').length - 1) === '/') {
            found = 1;
            oldText = $(this).text();
            $(this).html('<img class="icons" src="https://reckfularchive.github.io/files/assets/images/icons/folder.png">' + oldText.substring(0, oldText.length - 1));
        ...
        if (found === 0) {
            oldText = $(this).text();
            $(this).html('<img class="icons" src="https://reckfularchive.github.io/files/assets/images/icons/file.png">' + oldText);
        }
    });
});
